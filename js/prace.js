...
// PRACE_PIN a praceOdemceno jsou definovány v sablony.js (načítá se
// hned před tímto souborem). Duplicitní `const`/`let` tady společně
// s DEFAULT_SABLONY kolizí v pdf.js způsobovaly SyntaxError, který
// zablokoval celé sablony.js (včetně VYCHOZI_PRACE ceníku).
